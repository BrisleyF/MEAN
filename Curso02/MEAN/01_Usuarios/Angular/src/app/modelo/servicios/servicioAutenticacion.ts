...
export class ServicioAutenticacion {
    ...
    public constructor(private httpClient:HttpClient){
        //Esto es por si el usuario pulsa F5
    ...
    public logout():void{
        ...
        //Si un subject emite el evento "complite" todas las subscripciones activas se cancelara.
        //this.subjectUsuario.complete();
        //Una vez emitido el "complite" el subject no sirve y hay que crear uno nuevo.
